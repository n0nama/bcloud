    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to=b'messages_attach')),
                ('image', models.ImageField(null=True, upload_to=b'messages_attach')),
                ('favorite', models.ManyToManyField(related_name='favorite_msg', verbose_name='Favorite', to=settings.AUTH_USER_MODEL)),
                ('parent_msg', models.ForeignKey(related_name='next_messages', verbose_name='Parent message', blank=True, to='messag.Message', null=True)),
